...
const uint8_t Em_App_hash[] = {12, 139, 148, 69, 138, 197, 237, 36, 184, 140, 154, 73, 12, 155, 16, 13, 13, 0, ((sizeof(struct{uint8_t f1; uint16_t f2;}) - sizeof(uint16_t)) << 4) | (sizeof(struct{uint8_t f1; uint32_t f2;}) - sizeof(uint32_t))};

const uint8_t Em_App_build[] = {198, 237, 15, 80, 67, 1, 0, 0};

#define Em_App_APP_RESOURCE_COUNT 5
#define Em_App_SYS_RESOURCE_COUNT 9

#define Em_App_ACCEPT NewProject_accept
#define Em_App_ACTIVATEPARAMETERS NewProject_activateParameters
#define Em_App_BROADCASTOFF NewProject_broadcastOff
#define Em_App_DISCONNECT NewProject_disconnect
#define Em_App_PAIRINGON NewProject_pairingOn
#define Em_App_PAIRINGOFF NewProject_pairingOff
#define Em_App_RESET NewProject_reset
#define Em_App_SETDEVICENAME NewProject_setDeviceName
#define Em_App_START NewProject_start

#define Em_App_CONNECTHANDLER NewProject_connectHandler
#define Em_App_DISCONNECTHANDLER NewProject_disconnectHandler
...
void Em_App_fetchDispatch(void) {
    ...
    switch (Em_App_msg.hdr.resId) {
        ...
        case 2: {
#ifdef Em_16BIT
            NewProject_currentScene_t val;
            Em_App_valp = (uint8_t*)&val;
            Em_App_bufp = Em_App_msg.data;
            Em_App_desc = "111111111111111";
            NewProject_currentScene_fetch(&val);
            Em_App_marshallToBuf();
#else
            NewProject_currentScene_fetch((void*)Em_App_msg.data);
#endif
            size = 15;
            break;
        }
        case 4: {
#ifdef Em_16BIT
            NewProject_currentSequence_t val;
            Em_App_valp = (uint8_t*)&val;
            Em_App_bufp = Em_App_msg.data;
            Em_App_desc = "11*\x05[1]";
            NewProject_currentSequence_fetch(&val);
            Em_App_marshallToBuf();
#else
            NewProject_currentSequence_fetch((void*)Em_App_msg.data);
#endif
            size = 7;
            break;
        }
        case 5: {
#ifdef Em_16BIT
            NewProject_currentMode_t val;
            Em_App_valp = (uint8_t*)&val;
            Em_App_bufp = Em_App_msg.data;
            Em_App_desc = "1";
            NewProject_currentMode_fetch(&val);
            Em_App_marshallToBuf();
#else
            NewProject_currentMode_fetch((void*)Em_App_msg.data);
#endif
            size = 1;
            break;
        }
...
void Em_App_storeDispatch(void) {
    switch (Em_App_msg.hdr.resId) {
        ...
        case 1: {
#ifdef Em_16BIT
            NewProject_currentSceneId_t val;
            Em_App_valp = (uint8_t*)&val;
            Em_App_bufp = Em_App_msg.data;
            Em_App_desc = "1";
            Em_App_marshallToVal();
            NewProject_currentSceneId_store(&val);
#else
            NewProject_currentSceneId_store((void*)Em_App_msg.data);
#endif
            break;
        }
        case 2: {
            ...
            Em_App_desc = "111111111111111";
            Em_App_marshallToVal();
            NewProject_currentScene_store(&val);
#else
            NewProject_currentScene_store((void*)Em_App_msg.data);
#endif
            break;
        }
        case 3: {
#ifdef Em_16BIT
            NewProject_currentSequenceId_t val;
            Em_App_valp = (uint8_t*)&val;
            Em_App_bufp = Em_App_msg.data;
            Em_App_desc = "1";
            Em_App_marshallToVal();
            NewProject_currentSequenceId_store(&val);
#else
            NewProject_currentSequenceId_store((void*)Em_App_msg.data);
#endif
            break;
        }
        case 4: {
            ...
            Em_App_desc = "11*\x05[1]";
            Em_App_marshallToVal();
            NewProject_currentSequence_store(&val);
#else
            NewProject_currentSequence_store((void*)Em_App_msg.data);
#endif
            break;
        }
        case 5: {
            ...
            Em_App_desc = "1";
            Em_App_marshallToVal();
            NewProject_currentMode_store(&val);
#else
            NewProject_currentMode_store((void*)Em_App_msg.data);
#endif
            break;
        }
    }
